...
commandController.post('/register', (req, res) => {
...
commandController.post('/login', (req, res) => {
...
commandController.post('/send', (req, res) => {
...
queryController.get('/inbox/:username', (req, res) => {
...
queryController.get('/sent/:username', (req, res) => {
  const { username } = req.params
...
queryController.get('/allmails', (req, res) => {
  return res.json(sentEmails)
})

// ruta para guardar en favoritos de un usuario
commandController.post('/favorite/:username', (req, res) => {
  const { username } = req.params;
...
queryController.get('/favorite/:username', (req, res) => {
  const { username } = req.params;
...
commandController.delete('/favorite/:username', (req, res) => {
  const { username } = req.params;
  const { emailId } = req.body;
